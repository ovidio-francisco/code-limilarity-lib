...
-- l)cadastre 10 livros
	insert into Livro values(0,'Batata',2002,'Amém','São PAulo','d');
    insert into Livro values(0,'Amanhecer',2012,'Ontem','Cerquilho','e');
    insert into Livro values(0,'Sou Louca',2003,'Biruta','Tietê','d');
    insert into Livro values(0,'Não Mexa Comigo',2019,'AAA','Jumirim','e');
    insert into Livro values(0,'Amigos',2000,'Amém','Cerquilho','d');
    insert into Livro values(0,'2°Info',2017,'ETEC','São Paulo','e');
    insert into Livro values(0,'RAIVA',2014,'Ontem','Laranjal Paulista','d');
    insert into Livro values(0,'After',2015,'Biruta','Tatui','e');
    insert into Livro values(0,'1984',2018,'Hoje','Itu','d');
